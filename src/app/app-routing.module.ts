...
import { ShowCertificatesComponent } from './PcsComponent/show-certificates/show-certificates.component';
import { ShowSkillsComponent } from './PcsComponent/show-skills/show-skills.component';
...
const routes: Routes = [
  ...
  { path: 'show-skills', component: ShowSkillsComponent, pathMatch: 'full', canActivate: [AuthGuard] },
  { path: 'show-certificates', component: ShowCertificatesComponent, pathMatch: 'full', canActivate: [AuthGuard] },
